...
with st.sidebar:
    ...
    alp = st.number_input('Alkaline Phosphatase (ALP, U/L)', min_value=0.0, max_value=500.0, step=1.0, key='alp')
    ...
    crea = st.number_input('Creatinine (CREA, umol/L)', min_value=0.0, max_value=2000.0, step=1.0, key='crea')
